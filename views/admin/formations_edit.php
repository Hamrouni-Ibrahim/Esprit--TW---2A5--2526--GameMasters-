<?php 
$pageTitle = 'Modifier une Formation - Admin';
...
<section class="admin-content">
    ...
    <div class="admin-container">
        <?php if (isset($result) && $result) { ?>
            <h2 class="admin-header-section" style="font-size: 32px; margin-bottom: 30px;">Modifier une Formation</h2>

            <div class="admin-form-container">
                <form method="POST" action="?controller=formation&action=edit&id=<?php echo $result['id']; ?>" id="formationForm" onsubmit="return validateFormationForm()">
                    ...
                    <div class="admin-form-group">
                        ...
                        <input type="text" id="competences" name="competences" value="<?php echo htmlspecialchars($result['competences'] ?? ''); ?>" placeholder="ex: C#, Unity, Game Design">
                    </div>
                    ...
                    <div class="admin-form-group">
                        ...
                        <input type="text" id="categorie" name="categorie" value="<?php echo htmlspecialchars($result['categorie'] ?? ''); ?>" placeholder="ex: Plateforme 2D" required>
                    ...
                    <div class="admin-form-group">
                        ...
                        <textarea id="impact_social" name="impact_social" rows="5" placeholder="Informations facultatives sur l'impact communautaire"><?php echo htmlspecialchars($result['impact_social'] ?? ''); ?></textarea>
                    </div>
        ...
        <?php } else { ?>
            <div class="no-items">
                ...
                <div class="form-actions" style="justify-content: center; margin-top: 20px;">
                    <a href="?controller=formation&action=adminList" class="btn btn-secondary">Retour à la liste</a>
                </div>
            </div>
        <?php } ?>
    </div>
